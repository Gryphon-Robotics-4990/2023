...
public class AutoLeftCommand extends CommandBase{
    private final DrivetrainSubsystem m_drivetrain;

    public AutoLeftCommand(DrivetrainSubsystem drivetrain) {
    ...
    public SequentialCommandGroup getAutonomousCommand() {
        ...
        m_drivetrain.resetOdometry(leftStart.getInitialPose());
