...
public class AutoRightCommand extends CommandBase{
    private final DrivetrainSubsystem m_drivetrain;

    public AutoRightCommand(DrivetrainSubsystem drivetrain) {
    ...
    public SequentialCommandGroup getAutonomousCommand() {
        ...
        m_drivetrain.resetOdometry(rightStart.getInitialPose());
